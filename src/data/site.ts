...
export const locales: Record<Locale, LocaleContent> = {
  hu: {
    ...
    about: {
      ...
      highlights: [
        { label: "Szolgáltatási terület", value: "Elsődlegesen Ajka — országosan vagy külföldön is, megbeszélés alapján" },
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Vajda Papír Dunaföldvár", type: "Ipari" },
            { name: "Kométa Kaposvár", type: "Ipari" },
            { name: "Ganz Electric Transzformátorgyár Tápiószele", type: "Ipari" },
    ...
    contact: {
      ...
      serviceAreaValue: "Elsődlegesen Ajka — országosan vagy külföldön is, megbeszélés alapján, üzemanyag-térítéssel",
  ...
  en: {
    ...
    about: {
      ...
      highlights: [
        { label: "Service area", value: "Ajka region — nationwide and abroad by arrangement" },
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Vajda Papír Dunaföldvár", type: "Industrial" },
            { name: "Kométa Kaposvár", type: "Industrial" },
            { name: "Ganz Electric Transformer Plant Tápiószele", type: "Industrial" },
    ...
    contact: {
      ...
      serviceAreaValue: "Primarily Ajka — nationwide or abroad by arrangement with fuel costs covered",
  ...
  de: {
    ...
    about: {
      ...
      highlights: [
        { label: "Einsatzgebiet", value: "Hauptsächlich Ajka — landesweit oder im Ausland nach Absprache" },
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Vajda Papír Dunaföldvár", type: "Industrie" },
            { name: "Kométa Kaposvár", type: "Industrie" },
            { name: "Ganz Electric Transformatorenwerk Tápiószele", type: "Industrie" },
    ...
    contact: {
      ...
      serviceAreaValue: "Hauptsächlich Ajka — landesweit oder im Ausland nach Absprache, Fahrtkosten inbegriffen",
